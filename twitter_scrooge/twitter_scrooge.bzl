...
def twitter_scrooge():
    ...
    for version in versions:
        ...
        _scala_maven_install(
            ...
            name = "{repo_prefix}twitter_scrooge",
            artifacts = [
                "org.apache.thrift:libthrift:0.8.0",
                "com.twitter:scrooge-core_{scala_major_version}:18.6.0",
                "com.twitter:scrooge-generator_{scala_major_version}:18.6.0",
                "com.twitter:util-core_{scala_major_version}:18.6.0",
                "com.twitter:util-logging_{scala_major_version}:18.6.0",
            ],
        )
